 ...
 <div class="main">
  ...
  <ul class="pagination">
          <c:if test="${startPage>1 }">
            <li><a href="../booking/salon_list.do?page=${startPage-1 }">&laquo;</a></li>
          </c:if>
          <c:forEach var="i" begin="${startPage }" end="${endPage }">
            ...
            <li><a href="../booking/salon_list.do?page=${i }">${i }</a></li>
          </c:forEach>
          <c:if test="${endPage<totalpage }">
            <li><a href="../booking/salon_list.do?page=${endPage+1 }">&raquo;</a></li>
          </c:if>
        </ul>
        </div>
 </div>
